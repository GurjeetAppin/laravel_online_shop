    ...
    @include('admin.message')
        <div class="card">
            <div class="card-header">
                ...
                <button class="btn btn-default btn-sm" type="button" onclick="window.location.href='{{route("brands.index")}}'">Reset</button>
                </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="#" onclick="deleteBrand({{$brands->id}})" class="text-danger w-4 h-4 mr-1">
