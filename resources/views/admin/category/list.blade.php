...
@section('breadcrumb-item') Categories @endsection
@section('list') list @endsection
@section('content')
        ...
        <div class="card">
            <div class="card-header">
                <div class="card-title">
                    <button onclick="window.location.href='{{route("category.index")}}'" type="button" class="btn btn-default btn-sm">Reset</button>
                </div>
