                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="short_description" id="short_description" cols="2" rows="2" class="short_description" placeholder="Short Description"></textarea>
                                    </div>
                                </div>   
                                <div class="col-md-12">
                                    <div class="mb-3">
                                 ...
                                 <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="shipping_returns" id="shipping_returns" cols="30" rows="10" class="short_description" placeholder="shipping_returns"></textarea>
                                    </div>
                                </div>                                            
                            </div>
                        </div>	                                                                      
