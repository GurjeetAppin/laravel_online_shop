                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" value="{{$editSubCategory->name}}" placeholder="Name">	
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="slug" id="slug" class="form-control" value="{{$editSubCategory->slug}}" placeholder="Slug">	
                                    <p></p>
                                </div>
                            </div>	
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="status" id="status" class="form-control">
                                        ...
                                        <option value="1" {{($editSubCategory->status == 1) ? 'selected' : '' }}>Active</option>
                                        <option value="0" {{($editSubCategory->status == 0) ? 'selected' : '' }}>Block</option>
                                    </select>
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="showHome" id="showHome" class="form-control">
                                        <option value="">Select Status</option>
                                        <option value="Yes" {{($editSubCategory->showHome == "Yes") ? 'selected' : '' }}>Yes</option>
                                        <option value="No" {{($editSubCategory->showHome == "No") ? 'selected' : '' }}>No</option>
                                    </select>
                                    <p></p>
                                </div>
                            </div>
...
<script>
    ...
    $("#subCategoryForm").submit(function(event){
        ...
        $('button[type=submit]').prop('disabled', true);
        $.ajax({
            url : '{{route("sub-categories.update",$editSubCategory->id)}}',
            type : 'put',
