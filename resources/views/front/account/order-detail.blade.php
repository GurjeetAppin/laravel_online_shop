                                            ...
                                            <div class="col-4 col-md-3 col-xl-2">
                                               @php 
                                                ...
                                                @if(!empty($productImage->image))
                                                    <a href="javascript:void(0)"><img src="{{ asset('uploads/products/small/'.$productImage->image) }}" alt="..." class="img-fluid"></a>
                                                @else
                                                    <a href="javascript:void(0)"><img class="img-fluid" src="{{asset('front-assets/images/product-1.jpg')}}" alt="No Image">
                                                    </a>
                                                @endif
                                            </div>
                                            <div class="col">
                                                ...
                                                <p class="mb-4 fs-sm fw-bold">
                                                    <a class="text-body" href="javascript:void(0)">{{ $item->name }} x {{ $item->qty }}</a> <br>
