        ...
        @include('front.account.common.message')
                ...
                <div id="product-carousel" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner bg-light">
                        @if($product->product_images)
                            @foreach($product->product_images as $key => $images)
                                <div class="carousel-item {{ ($key == 0) ? 'active' : ''}}">
                                    <img class="w-100 h-100" src="{{ asset('uploads/products/large/'.$images->image) }}" alt="Image">
                                </div>
                            @endforeach()
                         @endif
                    </div>
            ...
            <div class="col-md-7">
                <div class="bg-light right">
                    ...
                    <!-- <a href="#" class="btn btn-dark" onclick="addToCart({{$product->id}})"><i class="fas fa-shopping-cart"></i> &nbsp;ADD TO CART</a> -->
                            ...
                            <div class="col-md-8">
                                <div class="row">
                                    <form action="" name="productRatingForm" id="productRatingForm" method="post">
                                        ...
                                        <div class="form-group mb-3" id="rating">
    ...
    <div class="container">
        ...
        <div class="col-md-12">
            <div id="related-products" class="carousel">
                    ...
                    @php
                        $productRelatedImage = $relatedProduct->product_images->first();
                    @endphp
                    <div class="card product-card">
                    <div class="product-image position-relative">
                        <a href="" class="product-img">
                            @if(!empty( $productRelatedImage->image))
                                <img class="card-img-top" src="{{ asset('uploads/products/small/'.$productRelatedImage->image) }}" alt="">
                            @else
                            <img class="card-img-top" src="{{ asset('uploads/products/small/product-8.jpg') }}" alt="">
                            @endif
                        </a>
